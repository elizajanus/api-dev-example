...
const { Location, Trip, Lane, Move } = require('./components'); 


const Charges = 
async function getRateRules(trip_id, callback) {
  try {
    //all this info will be in trip object
...
// });
    ...
    //     await models.Location.findById(origin_id)
    //     .then(res => {
    //         if (res != null) {
    //             console.log(`   Found ${res.name}`);
    //         } else if (err) {
    ...
    // await models.Location.findById(destination_id)
    // .then(res => {
    //     if (res != null) {
    //         console.log(`   Found ${res.name}`);
    //     } else if (err) {
    ...
    //         models.Lane.findOne({ where: {origin_location_id: origin_id, destination_location_id: destination_id} })
    //     .then(res => {
    //             if (res != null) {
    ...
    await models.RateOutput.create({
